...
const LingkunganEvent = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto px-3">
      <h1 className="mt-6 mb-6 text-3xl text-center font-bold">Limbah</h1>
      {listings && listings.length > 0 ? (
        ...
        <p>{isLoading ? 'Loading listings...' : 'There are no current offers'}</p>
      )}
    </div>
  );
};

export default LingkunganEvent;
