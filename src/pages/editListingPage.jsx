...
const EditListingPage = () => {
  ...
  // check that if the listing is belongs to the person who is editing it
  useEffect(() => {
  ...
  async function onSubmit(e) {
    ...
    // the documents reference is listings that are ID and we're going to fetch that listing and fill
    const docRef = doc(db, 'listings', params.listingId);
